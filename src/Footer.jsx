...
export default function Footer() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Add your code to handle form submission, like sending the email to your backend or API
        ...
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-1">
            ...
            <div className="space-y-3">
              ...
              <ul>
                <li>
                  <h1>Join our mailing list to get latest updates.</h1>
                  <form onSubmit={handleSubmit} className="flex">
                    <input
                      type="email"
                      placeholder="Your email"
                      className="py-2 px-4 mr-2 w-3/4 border border-gray-300 rounded-l focus:outline-none"
                      value={email}
