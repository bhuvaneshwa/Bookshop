        ...
        <div>
            <header className='border-b bg-white font-sans min-h-[60px] px-10 py-3 relative'>
                <div className='flex flex-wrap items-center max-lg:gap-y-6 max-sm:gap-x-4'>
                    <a href="javascript:void(0)"><img src={Logo} alt="logo" className=' w-52 h-20 hover:border-blue-400' />
                    </a>
                    ...
                    <ul id="collapseMenu"
                        ...
                        <li className=' mt-3 max-lg:border-b max-lg:py-2'><a href='javascript:void(0)'
                            className='hover:text-[#007bff] text-[15px] text-[#007bff] block font-bold'>Home</a></li>
                        <li className="mt-3 max-lg:border-b max-lg:py-2">
                            <button
                                type="button"
                                onClick={() => setIsMenuOpen(!isMenuOpen)} // Toggle menu on button click
                                className='hover:text-[#007bff] text-[15px] hover:font-bold font-bold text-gray-600'
                            >
                                Books
                            </button>

                            {/* Render the menu if isMenuOpen is true */}
                            {isMenuOpen && (
                        ...
                        <li className='mt-3 group max-lg:border-b max-lg:py-2 relative'>
                        ...
                        <li className='mt-3 max-lg:border-b max-lg:py-2'><a href='javascript:void(0)'
                            className='hover:text-[#007bff] text-gray-600 font-bold text-[15px] block'>Reviews</a></li>
                        <li className='max-lg:border-b max-lg:py-2'>
                            <Link to="/register/login">
                                <button
                                    className='hover:bg-[#007bff] hover:border-[#007bff] border border-gray-300 text-gray-600 font-bold text-[15px] py-2 px-4 rounded block ml-40 -mr-6'>
                                    Login
                                </button>
                            </Link>
                        </li>
                        <li className='max-lg:border-b max-lg:py-2'>
                            <Link to="/register">
                                <button
                                    className='hover:bg-[#007bff] hover:border-[#007bff] border border-gray-300 text-gray-600 font-bold text-[15px] py-2 px-4 rounded block -mr-24'>
                                    Signup
                                </button>
                            </Link>
                        </li>
                ...
                <div
                    className="bg-gray-100 border border-transparent focus-within:border-blue-500 flex px-6 rounded-full h-9 lg:w-2/4 mt-3 mx-auto max-lg:mt-6">
