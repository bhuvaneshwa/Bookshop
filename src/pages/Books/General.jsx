  ...
  return (
    <div className="mt-14 mb-12">
      <div className="flex flex-row justify-between">
        <h1 className="text-3xl font-bold aos-init aos-animate mt-10">
          General books
        </h1>
...
<<<<<<< HEAD
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 place-items-center gap-5 -mr-32">
          ...
          >
            <img
              src="https://images-us.bookshop.org/ingram/9780062963505.jpg?height=500&v=v2-314a5e611f125ea779c71f17189016c2"
              alt=""
...
>>>>>>> 633272d9880169d0221c6d780173906b291a55c4
            ...
            <a
              href="#"
              className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 mt-28 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Buy Now
            </a>
          </div>
